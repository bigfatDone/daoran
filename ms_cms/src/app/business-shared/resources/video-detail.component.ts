...
export class VideoDetailComponent implements OnInit {
  ...
  getDetail() {
    ...
    let that = this;
    let param;
      param = {jsonParam:JSON.stringify({videoCode: this.detailId})};
      this.resourcesBusinessService.videoInfo(param, function(data){
        ...
        that.SvidCode = data.data.videoCode;
        that.SvidName = data.data.videoName;
        that.StitleImg = data.data.videoImage;
        that.SvidtitleName = data.data.videoName;
  ...
  getvidPicInfo() {
    ...
    let param;
    param = {jsonParam:JSON.stringify({videoCode: this.detailId})};
    this.resourcesBusinessService.getVidPicDetail(param, function(data){
      that.imageData = data.data.imageList;
  ...
  setDefault(id){
    ...
    this.modalService.confirm(confirmCfg).then((result) => {
      that.resourcesBusinessService.setDefaultVidPic({jsonParam:JSON.stringify(param)}, function(data){
        that.getDetail();
  ...
  play(){
    let that = this;
    let params;
    let param= {videoCode: this.detailId};
    params={jsonParam:JSON.stringify(param)};
    this.resourcesBusinessService.videoPlay(params, function(data){
