...
export class ElementUploadImgComponent implements OnInit, OnDestroy {
  ...
  getDetail() {
    if (this.modalData !== "") {
      if (this.modalData.preFlag) {
        let strA = this.modalData.data.imageVa !== null ? JSON.parse(localStorage.userInfo).imageUrl + '/HD/' + this.modalData.data.imageVa + "?random=" + Math.random(): "";
        let strD = this.modalData.data.imageVa !== null ? JSON.parse(localStorage.userInfo).imageUrl + '/SD/' + this.modalData.data.imageVa + "?random=" + Math.random() : "";
        let strB = this.modalData.data.imageVb !== null ? JSON.parse(localStorage.userInfo).imageUrl + '/HD/' + this.modalData.data.imageVb + "?random=" + Math.random(): "";
        let strE = this.modalData.data.imageVb !== null ? JSON.parse(localStorage.userInfo).imageUrl + '/SD/' + this.modalData.data.imageVb + "?random=" + Math.random(): "";
        let strC = this.modalData.data.imageVc !== null ? JSON.parse(localStorage.userInfo).imageUrl + '/HD/' + this.modalData.data.imageVc + "?random=" + Math.random() : "";
        let strF = this.modalData.data.imageVc !== null ? JSON.parse(localStorage.userInfo).imageUrl + '/SD/' + this.modalData.data.imageVc + "?random=" + Math.random(): "";
        ...
        let strA = this.modalData.imageVa !== null ? JSON.parse(localStorage.userInfo).imageUrl + '/HD/' + this.modalData.imageVa + "?random=" + Math.random() : "";
        let strD = this.modalData.imageVa !== null ? JSON.parse(localStorage.userInfo).imageUrl + '/SD/' + this.modalData.imageVa + "?random=" + Math.random() : "";
        let strB = this.modalData.imageVb !== null ? JSON.parse(localStorage.userInfo).imageUrl + '/HD/' + this.modalData.imageVb + "?random=" + Math.random() : "";
        let strE = this.modalData.imageVb !== null ? JSON.parse(localStorage.userInfo).imageUrl + '/SD/' + this.modalData.imageVb + "?random=" + Math.random(): "";
        let strC = this.modalData.imageVc !== null ? JSON.parse(localStorage.userInfo).imageUrl + '/HD/' + this.modalData.imageVc + "?random=" + Math.random(): "";
        let strF = this.modalData.imageVc !== null ? JSON.parse(localStorage.userInfo).imageUrl + '/SD/' + this.modalData.imageVc  + "?random=" + Math.random(): "";
