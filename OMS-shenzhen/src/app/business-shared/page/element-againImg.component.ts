...
@Component({
  selector: 'c-againImg-againImg',
  templateUrl: './element-againImg.component.html',
  styleUrls: ['./element-uploadImg.component.scss']
})
export class ElementAgainImgComponent implements OnInit, OnDestroy {
  ...
  getDetail() {
    if (this.modalData !== "") {
      ...
      //   let strA = this.modalData.id.imageVa !== null ? this.imgApi + this.modalData.id.imageVa : "";
      //   let strD = this.modalData.id.imageVa !== null ? this.imgApiSD + this.modalData.id.imageVa : "";
      //   let strB = this.modalData.id.imageVb !== null ? this.imgApi + this.modalData.id.imageVb : "";
      //   let strE = this.modalData.id.imageVb !== null ? this.imgApiSD + this.modalData.id.imageVb : "";
      //   let strC = this.modalData.id.imageVc !== null ? this.imgApi + this.modalData.id.imageVc : "";
      //   let strF = this.modalData.id.imageVc !== null ? this.imgApiSD + this.modalData.id.imageVc : "";
      //
      //   this.inputFileA = "";
      //   this.inputFileB = "";
      //   this.inputFileC = "";
      ...
      //   this.imgSrcE = strE;
      //   this.imgSrcF = strF;
      //   this.des1 = this.modalData.id.imageVaDes === null ? '' : this.modalData.id.imageVaDes;
      //   this.des2 = this.modalData.id.imageVbDes === null ? '' : this.modalData.id.imageVbDes;
      //   this.des3 = this.modalData.id.imageVcDes === null ? '' : this.modalData.id.imageVcDes;
      //   this.imgSizeA = this.modalData.id.imageVaSize;
      //   this.imgSizeB = this.modalData.id.imageVbSize;
      //   this.imgSizeC = this.modalData.id.imageVcSize;
      // } else {
  ...
  ok(): void {
    ...
    if (this.modalData.preFlag || this.modalData.preAddFlag) {
      ...
      if ((ET === 'plist' || ET === 'vlist' || ET === 'res' || ET === 'album') && (this.newFile.get("fileA") !== '' || this.newFile.get("fileB") !== '' || this.newFile.get("fileC") !== '' || this.newFile.get("fileD") !== '' || this.newFile.get("fileE") !== '' || this.newFile.get("fileF") !== '')) {
      ...
      pb = this.modalData.imageVb;
      pc = this.modalData.imageVc;
      if (((ET === 'plist' || ET === 'vlist' || ET === 'res' || ET === 'album') && (pa !== null ||  pb !== null ||  pc !== null)) && (this.newFile.get("fileA") !== '' || this.newFile.get("fileB") !== '' || this.newFile.get("fileC") !== '' || this.newFile.get("fileD") !== '' || this.newFile.get("fileE") !== '' || this.newFile.get("fileF") !== '')) {
        this.showThisEleModal = this.ngbModalService.open(ElementConfirPicComponent, {size: 'sm'});
        this.showThisEleModal.result.then((result) => {
          this.isHas = result;
          this.edit();
