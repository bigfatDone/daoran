...
@Component({
  selector: 'c-element-page-check',
  templateUrl: './element-page-check.component.html'
})
export class ElementPageCheckComponent implements OnInit {
  ...
  getPageList() {
    ...
    this.pageBusinessService.elePageListPost(param, function(data){
