...
@NgModule({
  ...
  entryComponents: [CodeSaveComponent, TmpConfigSaveComponent,  TmpInfoSaveComponent, InOutChargeSaveComponent, InChargeSaveComponent, OutChargeSaveComponent, OrderChargeSaveComponent],
  exports:      [],
  providers:    [
