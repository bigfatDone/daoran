  ...
  getDetail() {
    if (this.modalData !== '') {
      ...
      this.programBusinessService.getProgramDetail(param, function(data){
        ...
        that.imgSrcA = JSON.parse(localStorage.userInfo).imageUrl + '/HD/' + data.image;
        that.imgSrcC = JSON.parse(localStorage.userInfo).imageUrl + '/SD/' + data.image;
        that.imgSrcB = JSON.parse(localStorage.userInfo).imageUrl + '/HD/' + data.imageSecond;
        that.imgSrcD = JSON.parse(localStorage.userInfo).imageUrl + '/SD/' + data.imageSecond;
