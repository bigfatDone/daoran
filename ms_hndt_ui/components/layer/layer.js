...
! function(a, b) {
    ...
    }, e.rescollbar = function(a) { g.html.attr("layer-full") == a && (g.html[0].style.removeProperty ? g.html[0].style.removeProperty("overflow") : g.html[0].style.removeAttribute("overflow"), g.html.removeAttr("layer-full")) }, layer.getChildFrame = function(a, b) {
    ...
    }, "function" == typeof defines ? defines(function() {
        return e.run(), layer
    }) : function() { e.run() }();
}(window);
