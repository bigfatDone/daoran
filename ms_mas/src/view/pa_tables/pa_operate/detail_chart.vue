  ...
  <div class="chart-wrap">
    <div class="chart-setting">
      <div class="chart-conditionType">
        <el-button-group>
          <el-button v-for="(item,index) in selectbars" :key="item.text" @click="chartChange(item.code,item.chartType)" :class="{ 'active-button-group': item.status }">{{item.text}}</el-button>
        </el-button-group>
      </div>
      <!--wap btns begin-->
      <div class="wap-btns">
