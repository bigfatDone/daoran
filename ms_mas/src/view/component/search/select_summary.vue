...
//      that.$emit("condition", data);
      ...
      updateParent() {
        ...
        let data = {province: that.nodeProvince.node, city: that.nodeProvince.province, product: that.nodeProvince.product};
        console.log(that.nodeProvince);
        console.log(data);
        that.$emit("condition", data);
      },
