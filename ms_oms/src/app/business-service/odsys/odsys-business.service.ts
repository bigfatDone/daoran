...
export class OdsysBusinessService {
  ...
  api: any = {
    ...
    // 订购关系
    getTaskInfoList: '/busi/taskInfo/getTaskInfoList',
    getProvinceinfo : '/busi/projectProvinceProduce/getProvince',
    uploadRelationship : '/busi/file/upload',
    saveTaskInfoRelationship : '/busi/taskInfo/saveTaskInfo',
    delTaskInfo : '/busi/taskInfo/delTaskInfo',
  };
  delTaskInfo(param, callback) {
    this.httpService.postFormData(this.api.delTaskInfo, param, function (successful, data, res) {
      if (successful) {
        callback(data.obj);
      }
  ...
  saveTaskInfoRelationship(param, callback) {
    this.httpService.postFormData(this.api.saveTaskInfoRelationship, param, function (successful, data, res) {
      if (successful) {
        callback(data.obj);
      }
    }, function (successful, msg, err) {
  ...
  uploadRelationship(param, callback) {
    this.httpService.postFormFile(this.api.uploadRelationship, param, function (successful, data, res) {
      if (successful) {
        callback(data.obj);
      }
    }, function (successful, msg, err) {
  ...
  getTaskInfoList(param, callback) {
    this.httpService.postFormData(this.api.getTaskInfoList, param, function (successful, data, res) {
      if (successful) {
        callback(data.obj);
      }
    }, function (successful, msg, err) {
  ...
  getProvinceinfo(param, callback) {
    this.httpService.postFormData(this.api.getProvinceinfo, param, function (successful, data, res) {
      if (successful) {
        callback(data.obj);
      }
    }, function (successful, msg, err) {
