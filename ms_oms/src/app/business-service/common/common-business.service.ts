...
export class CommonBusinessService {
  ...
  api: any = {
    ...
    addImportPlanExcel: '/busi/plan/addImportPlanExcel'
  };
  ...
  addImportPlanExcel(param, callback) {
    this.httpService.postFormFile(this.api.addImportPlanExcel, param, function (successful, data, res) {
      if (successful) {
        callback(data);
      }
    }, function (successful, msg, err) {
