...
import {ElementNewTemplateSave} from './elementNewTemplate/elementNewTemplateSave.component';
...
@NgModule({
  ...
  declarations: [
    ...
    ElementNewTemplateComponent,
    ElementNewTemplateSave
  ],
  entryComponents: [AlbumTempSaveComponent, ElementSaveComponent, ElementNewTemplateComponent, ElementNewTemplateSave],
  exports:      [],
  providers:    [
