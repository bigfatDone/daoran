...
@Component({
  selector: 'c-album-confirSave',
  templateUrl: './album-confirSave.component.html',
  styleUrls: ['./album-confirSave.component.scss']
})
export class AlbumConfirSaveComponent implements OnInit {
