...
@NgModule({
  ...
  declarations: [
    VersionSaveComponent, VipSaveComponent, VerapkSaveComponent, OperateSaveComponent, ElementSaveComponent, ElementCheckComponent
  ],
  entryComponents: [VersionSaveComponent, VipSaveComponent, VerapkSaveComponent, OperateSaveComponent, ElementSaveComponent, ElementCheckComponent],
  exports:      [],
  providers:    [
