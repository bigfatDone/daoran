...
@Component({
  selector: 'c-element-vlist-check',
  templateUrl: './element-vlist-check.component.html'
})
export class ElementVlistCheckComponent implements OnInit {
  ...
  getList() {
    ...
    this.pageBusinessService.eleVListPost(param, function(data){
