...
export class TemplateBComponent implements OnInit, OnDestroy {
    ...
    this.pageBusinessService.getPartConfig(param, function(res){
      if (res.success) {
        ...
        if (res.obj[0].pageConfigPartEleList.length > 0) {
          ...
          if (res.obj[0].pageConfigPartEleList[2] !== undefined) {
            that.part1Img.part1Img3 = environment.imgApi + res.obj[0].pageConfigPartEleList[2].elementInfo.imageVa;
          }
        }
        ...
        if (res.obj[2].pageConfigPartEleList.length > 0) {
          that.part3Img.part1Img1 = environment.imgApi + res.obj[2].pageConfigPartEleList[0].elementInfo.imageVa;
          if (res.obj[2].pageConfigPartEleList[1] !== undefined) {
            that.part3Img.part1Img2 = environment.imgApi + res.obj[2].pageConfigPartEleList[1].elementInfo.imageVa;
          }
          if (res.obj[2].pageConfigPartEleList[2] !== undefined) {
            that.part3Img.part1Img3 = environment.imgApi + res.obj[2].pageConfigPartEleList[2].elementInfo.imageVa;
          }
        }
        if (res.obj[3].pageConfigPartEleList.length > 0) {
          that.part4Img = environment.imgApi + res.obj[3].pageConfigPartEleList[0].elementInfo.imageVa;
        }
        that.floorList = res.obj.splice(3);
      }
    });
  }
  editFloor(data) {
