...
@Component({
  selector: 'c-element-wall-check',
  templateUrl: './element-wall-check.component.html'
})
export class ElementwallCheckComponent implements OnInit {
  ...
  getList() {
    ...
    let param = {
      ...
      wallName: this.SwallName,
      eleCategory:this.sEleCategory
     // resType: this.modalType.resType
    }
    this.pageBusinessService.getEleValWallData(param, function(data){
