...
export class UserSaveComponent implements OnInit, AfterViewInit {
  ...
  constructor(public activeModal: NgbActiveModal,
    ...
    const userNameFc = new FormControl('', Validators.compose([Validators.required, CustomValidators.numLetter, Validators.minLength(1), Validators.maxLength(16)]));
    const realNameFc = new FormControl('', Validators.compose([Validators.required,  Validators.minLength(1), Validators.maxLength(16)]));
    const passwordFc = new FormControl('', Validators.compose([Validators.required, CustomValidators.numLetterCase, Validators.minLength(6), Validators.maxLength(20)]));
