...
export class HttpService {
  ...
  public request(url: string, body: any, options: RequestOptionsArgs, success: Function, error: Function, isNeedLoad: boolean = true, method: String = "post"): any {
    ...
    thisHttp.subscribe(res => {
      ...
      // if (!res.json().success && res.json().msg === "请登陆") {
      ...
      // // }
      // else
        if (!res.json().success && res.json().msg !== "未登录" ) {
  ...
  public post(url: string, body: any = null, success: Function=function(successful, data, res){}, error: Function=function(successful, msg, err){}, isNeedLoad: boolean = true): any {
