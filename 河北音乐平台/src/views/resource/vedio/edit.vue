<template>
  <div class="video-edit" v-loading="pageload">
    ...
    <el-row :gutter="20">
      <el-col :xs="24" :sm="24" :md="6" :lg="4" :xl="4">
        <div class="videoImg">
          <img :src="url.img_pre + videoData.videoImage">
        </div>
      </el-col>
      <el-col :xs="24" :sm="24" :md="18" :lg="20" :xl="20">
        <el-col :span="24"><h1>{{videoData.videoName || ''}}</h1></el-col>
        <el-col :spam="24">
          <el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
            <p>资源编码：{{videoData.videoCode || ''}}</p>
          </el-col>
          <el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
            <p>时长：{{videoData.allTime}}</p>
          </el-col>
          <el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
            <p>更新时间：{{videoData.lastTime}}</p>
          </el-col>
          <el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
            <p>CP商：{{videoData.cpId}}</p>
          </el-col>
          <el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
            <p>分辨率：{{videoData.resolution || '未知'}}</p>
          </el-col>
          <el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
    ...
    <el-row>
      ...
      <el-form label-position="left" label-width="120px">
        ...
        <label class="radio-inline" v-for="item in vipData" >
          <input type="radio" name="eleAttr" v-model="videoData.vip" :value="item.value" /> {{item.name}}
        </label>
      </el-form>
    </el-row>
    <el-row>
      ...
      <el-form label-position="left" label-width="120px">
        ...
        <el-form-item label="资源名称首字母">
          <el-input placeholder="资源名称首字母" v-model="videoData.upperCase"></el-input>
        </el-form-item>
        <el-form-item label="唱K标识">
          <el-radio-group v-model="videoData.klokFlag">
            <el-radio v-for="item in klokFlagData" :key="item.type" :label="item.type">{{item.name}}</el-radio>
          </el-radio-group>
        </el-form-item>
        <el-form-item label="描述">
          <el-input type="textarea" placeholder="描述" v-model="videoData.des"></el-input>
        </el-form-item>
        <el-form-item label="图片" v-loading="picLoading">
          <ul class="imgList">
            <li v-for="(item, index) in videoData.imageList" :class="{'default': item.displayType == 1}" @click="bigPic(item.image)">
            ...
            <li style="padding: 0; border: 0;">
              <el-upload
                action="/cms/api/video/uploadVideoImg.do"
        ...
        <el-form :inline="true" label-position="left" label-width="100px" class="demo-form-inline">
            ...
            <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="6">
              <el-form-item label="别名(英文名)">
                <el-input  placeholder="别名(英文名)" v-model="videoData.foreignName"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="6">
              <el-form-item label="制作人">
                <el-input  placeholder="制作人" v-model="videoData.producer"></el-input>
              </el-form-item>
            </el-col>
            ...
            <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="6">
              <el-form-item label="语种">
                <el-input  placeholder="语种" v-model="videoData.language"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="6">
              <el-form-item label="MV导演">
                <el-input  placeholder="MV导演" v-model="videoData.directorMV"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="12">
              <el-form-item label="发行地区">
                <el-input  placeholder="发行地区" v-model="videoData.publishArea"></el-input>
              </el-form-item>
            </el-col>

            <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="6">
              <el-form-item label="作词">
                <el-input  placeholder="作词" v-model="videoData.lyricist"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="6">
              <el-form-item label="专辑">
                <el-input  placeholder="专辑" v-model="videoData.albumName"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="12">
              <el-form-item label="唱片公司">
                <el-input  placeholder="唱片公司" v-model="videoData.redordCompany"></el-input>
              </el-form-item>
            </el-col>

            <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="6">
              <el-form-item label="作曲">
                <el-input  placeholder="作曲" v-model="videoData.composer"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="6">
              <el-form-item label="编曲">
                <el-input  placeholder="编曲" v-model="videoData.arranger"></el-input>
              </el-form-item>
            </el-col>
...
export default {
  ...
  data () {
    return {
      ...
      klokFlagData: [{type: 0, name: '非唱K资源'}, {type: 1, name: '可唱K资源'}],
      url: {
        img_pre     : this.$root.staticData.imgApi,
        videoDetail : '/cms/api/video/details.do',
        ...
        save        : '/cms/api/video/updateVideoInfo.do',
        getImgList  : '/cms/api/video/getImageList.do',
        delpic      : '/cms/api/video/deleteImage.do',
        setDefault  : '/cms/api/video/updateImageDisplay.do',
  ...
  watch: {
    '$route' (to, from) {
      if (to.path == '/video/edit') {
        //this.getDetail();
        if (location.hash.split("=")[1] == sessionStorage.getItem("videoCode")) {
          return
        }else {
          this.getDetail();
  ...
  methods: {
    ...
    videoUpload (file, fileList){
      this.videoPicData.file = file.name;
      this.videoPicData.videoCode = this.videoData.videoCode;
    },
    setDefault (imageCode) {
      // window.event  ? window.event.cancelBubble = true  : event.stopPropagation();
      let that = this;
      let videoCode = this.video_code.length > 0 ? this.video_code : sessionStorage.getItem("videoCode")
      let params = {jsonParam: JSON.stringify({videoCode: videoCode, imageCode: that.dialogSetDefaultImgCode})};
    ...
    getImgList () {
      let that = this;
      let videoCode = this.video_code.length > 0 ? this.video_code : sessionStorage.getItem("videoCode")
      let params = {jsonParam: JSON.stringify({videoCode: videoCode})};
      ...
      //   }).then(res => {
      //     if(res.data.success) {
      //       that.videoData.imageList = res.data.data.imageList;
      //     }else {
      //       that.$message({
      //         message: res.data.msg,
      //         type: 'warning'
    ...
    save () {
      ...
      for (let i in save_content) {
        save_content[i] = this.videoData[i];
      }
    ...
    renewArtList () {
      let that = this;
      let param = {resCode: this.video_code};
      ...
      //   data: this.Qs.stringify(params)
      // }).then(res => {
      //   that.videoData.artistList = res.data.data;
      //   this.videoData.artistList.forEach(item => {
      ...
      that.$ajax({
        ...
        success: function (res) {
          that.videoData.artistList = res.data.data;
          that.videoData.artistList.forEach(item => {
            item.areaText = that.dealArea(item.artistArea);
            item.typeText = that.dealType(item.artistType);
          });
        },
    ...
    dropRequest () {
      ...
      that.$ajax({
        ...
        success: function (res) {
          console.log(res)
          // that.videoData.artistList.splice(this.dropIndex, 1);
          // that.actDone();
          that.renewArtList();
          that.$message({
            message: res.data.msg,
    ...
    getDetail () {
      ...
      if (code) {
        sessionStorage.setItem("videoCode", code);
        this.video_code = code;
      }else {
        this.video_code = sessionStorage.getItem("videoCode");
      }
      let url = this.video_code;
      let parm = {videoCode: url}
      let that = this;
