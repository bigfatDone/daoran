  ...
  <div style="margin-bottom: 50px;position: relative;">
    ...
    <el-col :xs="6" :sm="6" :md="6" :lg="6" :xl="6">
      <el-upload style="width:80px"
                 class="upload-excel"
                 action="/cms/busi/album/importAlbumExcel.do"
                 accept="xls"
                 :data="excelParam"
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button size="mini" @click="closeImportUp">取消</el-button>
...
export default {
  ...
  methods: {
    templateLoad () {
      window.open('/cms/busi/album/downloadAlbumAddExcel.do');
    },
