   ...
   <!--新增、修改-->
    <el-dialog
      ...
      <el-form
        ...
        size="mini">
        <el-form-item prop='incomePayDes' label="类型名称:">
          <div class="w400">
...
export default {
  ...
  data () {
    return {
      ...
      Qs: this.$root.Qs,
      url: {
        tagTypeList : "/cms/api/tagType/list.do",
        tagTypeDetial : "/cms/api/tagType/getById.do",
        tagTypeSave : "/cms/api/tagType/save.do",
        tagTypeDel : "/cms/api/tagType/del.do",
        tagTypeSelect : "/cms/api/tagType/select.do",
      },
      dialog: {
        disabledFlag: false,
        width:'400px',
  ...
  methods: {
    ...
    ResultDeal (res) {
      ...
      that.tableData = res.data.data.tagTypeList || [];
